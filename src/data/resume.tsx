...
export const DATA = {
  ...
  summary:
    "With a background in **Industrial Engineering** and focus on *Business Intelligence*, I've successfully transitioned into software development. During university, I specialized in **data-driven decision making** and worked as a *Data Engineer*. Now as a **freelance developer**, I combine my engineering background with technical expertise to deliver efficient solutions. My unique perspective bridges the gap between **business needs** and *technical implementation*, creating systems that drive real value. Recently graduated in 2023, I continue merging **engineering principles** with *modern software practices*.",
  avatarUrl: "/me1.jpg",
  skills: [
    "React",
    "Next.js",
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Implemented machine learning models for electrical supply/demand prediction. Collaborated with designers and developers to create innovative solutions. Generated monthly analytical reports and insights.",
    },
    {
      company: "Ferrero",
      badges: [],
      ...
      description:
        "Automated processes using Python scripts. Developed KPIs and PowerBI dashboards for business insights. Conducted data analysis and generated comprehensive reports.",
    },
  ],
  education: [
    {
